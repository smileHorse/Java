...
public class StackedBarChart3DDemo3 extends ApplicationFrame {
   ...
   private static JFreeChart createChart(CategoryDataset var0) {
      JFreeChart var1 = ChartFactory.createStackedBarChart3D("Stacked Bar Chart 3D Demo 3", "Category", "Value", var0, PlotOrientation.HORIZONTAL, true, true, false);
      ...
      var3.setBaseNegativeItemLabelPosition(new ItemLabelPosition(ItemLabelAnchor.CENTER, TextAnchor.CENTER));
      return var1;
   }
   ...
   public static void main(String[] var0) {
      StackedBarChart3DDemo3 var1 = new StackedBarChart3DDemo3("Stacked Bar Chart 3D Demo 3");
      var1.pack();
