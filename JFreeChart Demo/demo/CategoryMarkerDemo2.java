...
public class CategoryMarkerDemo2 extends ApplicationFrame {
   ...
   public CategoryMarkerDemo2(String var1) {
      super(var1);
   ...
   private static JFreeChart createChart(CategoryDataset var0) {
      JFreeChart var1 = ChartFactory.createLineChart("Category Marker Demo 2", "Category", "Count", var0, PlotOrientation.VERTICAL, true, true, false);
      ...
      CategoryMarker var5 = new CategoryMarker("Category 4", new Color(0, 0, 255, 25), new BasicStroke(1.0F));
      var5.setDrawAsLine(false);
      var5.setAlpha(1.0F);
   ...
   public static void main(String[] var0) {
      CategoryMarkerDemo2 var1 = new CategoryMarkerDemo2("JFreeChart: CategoryMarkerDemo2.java");
      var1.pack();
