...
public class AxisRangeDemo2 extends JFrame {
   ...
   public AxisRangeDemo2(String var1) {
      super(var1);
   ...
   public static JPanel createDemoPanel() {
      AxisRangeDemo2.CustomDemoPanel var0 = new AxisRangeDemo2.CustomDemoPanel(new BorderLayout());
      var0.setPreferredSize(OrsonChartsDemo.DEFAULT_CONTENT_SIZE);
      CategoryDataset3D var1 = createDataset();
      Chart3D var2 = Chart3DFactory.createBarChart("AxisRangeDemo2", "Chart created with Orson Charts", var1, "Row", "Category", "Value");
      ...
      BarRenderer3D var4 = (BarRenderer3D)var3.getRenderer();
   ...
   public static void main(String[] var0) {
      AxisRangeDemo2 var1 = new AxisRangeDemo2("OrsonCharts: AxisRangeDemo2.java");
      var1.pack();
