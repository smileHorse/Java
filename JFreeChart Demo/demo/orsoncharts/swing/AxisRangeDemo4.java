...
public class AxisRangeDemo4 extends JFrame {
   ...
   public AxisRangeDemo4(String var1) {
      super(var1);
   ...
   public static JPanel createDemoPanel() {
      AxisRangeDemo4.CustomDemoPanel var0 = new AxisRangeDemo4.CustomDemoPanel(new BorderLayout());
      var0.setPreferredSize(OrsonChartsDemo.DEFAULT_CONTENT_SIZE);
      CategoryDataset3D var1 = createDataset();
      Chart3D var2 = Chart3DFactory.createStackedBarChart("AxisRangeDemo4", "A test for axis range changes on a stacked bar chart", var1, "Row", "Category", "Value");
      ...
      StackedBarRenderer3D var4 = (StackedBarRenderer3D)var3.getRenderer();
   ...
   private static CategoryDataset3D createDataset() {
      ...
      var0.addSeriesAsRow("S4", "B", var4);
      return var0;
   }

   public static void main(String[] var0) {
      AxisRangeDemo4 var1 = new AxisRangeDemo4("OrsonCharts: AxisRangeDemo4.java");
      var1.pack();
   ...
   static class CustomDemoPanel extends DemoPanel implements ChangeListener {
      ...
      public CustomDemoPanel(LayoutManager var1) {
         ...
         var2.add(new JLabel("Lower bound: "));
