...
public class LineChart3DDemo1 extends JFrame {
   ...
   public static JPanel createDemoPanel() {
      ...
      CategoryDataset3D var1 = LineChart3D1.createDataset();
      Chart3D var2 = LineChart3D1.createChart(var1);
   ...
   public static void main(String[] var0) {
      LineChart3DDemo1 var1 = new LineChart3DDemo1("OrsonCharts: LineChart3DDemo1.java");
      var1.pack();
