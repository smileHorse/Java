...
public class MultipleAxisDemo2 extends ApplicationFrame {
   ...
   public MultipleAxisDemo2(String var1) {
      super(var1);
   ...
   private static JFreeChart createChart() {
      ...
      JFreeChart var1 = ChartFactory.createTimeSeriesChart("Multiple Axis Demo 2", "Time of Day", "Primary Range Axis", var0, true, true, false);
      ...
      XYDataset var5 = createDataset("Series 2", 1000.0D, new Minute(), 170);
   ...
   public static void main(String[] var0) {
      MultipleAxisDemo2 var1 = new MultipleAxisDemo2("JFreeChart: MultipleAxisDemo2.java");
      var1.pack();
