...
public class HighLowChartDemo1 extends ApplicationFrame {
   ...
   public HighLowChartDemo1(String var1) {
      super(var1);
   ...
   private static JFreeChart createChart(OHLCDataset var0) {
      JFreeChart var1 = ChartFactory.createHighLowChart("High-Low-Open-Close Demo", "Time", "Price", var0, true);
   ...
   public static void main(String[] var0) {
      HighLowChartDemo1 var1 = new HighLowChartDemo1("JFreeChart: HighLowChartDemo1.java");
      var1.pack();
