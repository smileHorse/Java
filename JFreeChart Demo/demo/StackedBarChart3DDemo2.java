...
public class StackedBarChart3DDemo2 extends ApplicationFrame {
   ...
   public StackedBarChart3DDemo2(String var1) {
      super(var1);
   ...
   private static JFreeChart createChart(CategoryDataset var0) {
      JFreeChart var1 = ChartFactory.createStackedBarChart3D("Stacked Bar Chart 3D Demo 2", "Category", "Value", var0, PlotOrientation.VERTICAL, true, true, false);
      CategoryPlot var2 = (CategoryPlot)var1.getPlot();
      NumberAxis var3 = (NumberAxis)var2.getRangeAxis();
      var3.setNumberFormatOverride(new DecimalFormat("0.0%"));
   ...
   public static void main(String[] var0) {
      StackedBarChart3DDemo2 var1 = new StackedBarChart3DDemo2("Stacked Bar Chart 3D Demo 2");
      var1.pack();
