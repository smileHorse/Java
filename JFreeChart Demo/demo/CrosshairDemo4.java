...
public class CrosshairDemo4 extends ApplicationFrame {
   ...
   public CrosshairDemo4(String var1) {
      super(var1);
   ...
   private static JFreeChart createChart(XYDataset var0) {
      JFreeChart var1 = ChartFactory.createXYLineChart("Crosshair Demo 4", "X", "Y", var0, PlotOrientation.VERTICAL, true, true, false);
   ...
   public static void main(String[] var0) {
      CrosshairDemo4 var1 = new CrosshairDemo4("JFreeChart: CrosshairDemo4.java");
      var1.pack();
