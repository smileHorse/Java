...
public class LayeredBarChartDemo1 extends ApplicationFrame {
   ...
   public LayeredBarChartDemo1(String var1) {
      super(var1);
   ...
   private static JFreeChart createChart(CategoryDataset var0) {
      JFreeChart var1 = ChartFactory.createBarChart("Layered Bar Chart Demo 1", "Category", "Value", var0, PlotOrientation.VERTICAL, true, true, false);
   ...
   public static void main(String[] var0) {
      LayeredBarChartDemo1 var1 = new LayeredBarChartDemo1("JFreeChart: LayeredBarChartDemo1.java");
      var1.pack();
