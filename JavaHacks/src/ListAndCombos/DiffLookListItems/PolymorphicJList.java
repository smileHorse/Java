package ListAndCombos.DiffLookListItems;
...
public class PolymorphicJList extends JList {
    ...
    protected void buildIcons() {
        ...
        fileIcon = new ImageIcon ("image" + SEP + "generic.gif");
        textFileIcon = new ImageIcon ("image" + SEP + "text.gif");
        directoryIcon = new ImageIcon ("image" + SEP + "folder.gif");
        imageFileIcon = new ImageIcon ("image" + SEP + "image.gif");
        pngFileIcon = new ImageIcon ("image" + SEP + "png.gif");
        gifFileIcon = new ImageIcon ("image" + SEP + "gif.gif");
        jpegFileIcon = new ImageIcon ("image" + SEP + "jpeg.gif");
    }
